        ...
        <article class="container-fluid p-0 mainCentro alturaMain">
            ...
            <div class="mt-3 text-center titulosAccount ">
                ...
                <div class="container-fluid mt-5 p-3 bg-preto">
                    <a href="details.html" class="minhacontaHover"><p class="p-2">Details <i class="fas fa-info-circle pl-1" style="color: #eab200"></i></p></a>
                    <a href="settings.html" class="minhacontaHover"><p class="p-2">Settings <i class="fa fa-cog pl-1" style="color: #eab200"></i></p></a>
                    <a href="favorites.html" class="minhacontaHover"><p class="p-2">My Favourites <i class="fas fa-heart pl-1" style="color: #eab200"></i></p></a>
                    <a href="EE/Building2.html" class="minhacontaHover"><p class="p-2">Recently Watched <i class="fas fa-eye pl-1" style="color: #eab200"></i></p></a>
                    <a href="faq.html" class="minhacontaHover"><p class="p-2">FaQ <i class="fas fa-question pl-1" style="color: #eab200"></i></p></a>
                    <a href="terms.html" class="minhacontaHover"><p class="p-2">Terms And Conditions <i class="fas fa-clipboard pl-1" style="color: #eab200"></i></p></a>
                </div>
