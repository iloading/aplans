...
<body>
  ...
  <nav class="navbar navbar-dark navbar-expand-lg bg-preto justify-content-start">
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse dual-nav w-50 mobileMenu d-flex flex-column flex-lg-row justify-content-lg-around p-3 p-lg-0 mt-6 mt-lg-0">
        <ul class="navbar-nav align-self-stretch menuAlinhado h-100">
          ...
          <li class="nav-item m-2 mt-0">
            ...
            <a class="nav-link pl-2 d-inline" href="movies.html">Movies</a>
          </li>
          <li class="nav-item m-2">
            <i class="fas fa-desktop text-white"></i>
            <a class="nav-link pl-2 d-inline" href="tvshow.html">TV Shows</a>
          </li>
          <li class="nav-item m-2 dropdown">
            ...
            <div class="dropdown-menu scroll bg-30 pt-0 pb-0">
          ...
          <li class="nav-item m-2 mt-4 d-lg-none">
            ...
            <div class="m-3"><i class="fas fa-info-circle text-white"></i><a class="nav-link ml-3 d-inline" href="">Details</a></div>
            <div class="m-3"><i class="fas fa-heart text-white"></i><a class="nav-link ml-3 d-inline" href="">My Favorites</a></div>
      ...
      <a href="/" class="navbar-brand mx-auto d-flex text-center pr-5 pr-lg-0"> <img class="" src="./imagens/logo/logo_nav2.png" alt="">
              ...
              <div class="dropdown-content">
                ...
                <ul class="navbar-nav d-flex flex-column w-100">
                  ...
                  <li class="nav-item mt-2 pl-2 pr-2 bg-30" style="border-radius: 10px 10px 0 0;">
                    <a class="nav-link d-inline pr-2 font-weight-bolder" href="">My Account</a><i class="fas fa-chevron-right" style="padding-top: 0.3rem; color:rgba(255, 255, 255, 0.8)"></i>
                    <div class="m-3"><i class="fas fa-info-circle text-white"></i><a class="nav-link ml-1 d-inline" href="">Details</a></div>
                    <div class="m-3"><i class="fas fa-heart text-white"></i><a class="nav-link ml-1 d-inline" href="">My Favorites</a></div>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active h-100">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card mb-2">
              <img class="card-img-top" src="imagens/index/main1.jpg"
                alt="Card image cap">
              <div class="card-body">
          ...
          <div class="col-md-4 clearfix d-none d-md-block h-100">
            <div class="card mb-2">
        ...
        <footer class="mt-auto w-100">
            <div class="container-fluid text-center p-0 pt-4 justify-content-center">
                <div class="row mx-auto w-75">
                    <a class="col-4" href="#"> <p class="m-0" >About</p></a>
                    <a class="col-4" href="#"> <p class="m-0">Legal</p></a>
                    <a class="col-4" href="#"> <p class="m-0">Privacy</p></a>
                </div>
                <div class="row mx-auto w-75">
                    <a class="col-4" href="#">  <p class="mt-2">Jobs</p></a>
                    <a class="col-4" href="#">  <p class="mt-2">Cookies</p></a>
                    <a class="col-4" href="#">  <p class="mt-2">Terms of Use</p></a>
                </div>
