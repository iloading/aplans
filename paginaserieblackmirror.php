...
<body>
    ...
    <main class="alturaMain text-white bg-30 d-flex flex-column align-items-start">
        <article class="container-fluid p-0 mb-5">
            <div id="back5" class="imgSeriesBlackMirror mt-0">
                ...
                <div class="container-fluid alturaCategorias backgroundCategorias">
                    ...
                    <div class="row pb-2">
                        <h3 class="col-12 m-0 text-center font-weight-bold" style="font-size: 3rem">Black Mirror</h3>
                    </div>
                    <div class="row pb-2">
                        <p class="col-12 m-0 text-center">2011</p>
                    </div>
            ...
            <div class="tile m-0 w-100" id="tile-1">
                ...
                <div class="tab-content scrollSeason">
                    <div class="tab-pane show active pt-0 linksCategorias" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <a href="playerBlackMirror.html">
                            <div class="row mb-2 bg-preto">
                                <div class="col-4 p-0"><img class="tamanhoImagem" src="imagens/categorias/series/blackmirror/preview.jpg"></div>
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 1 <span class="text-dourado">&bull;</span> The National Anthem</p>
                        ...
                        <a href="playerBlackMirror.html">
                            <div class="row mb-2 bg-preto">
                                <div class="col-4 p-0"><img class="tamanhoImagem" src="imagens/categorias/series/blackmirror/preview.jpg"></div>
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 2 <span class="text-dourado">&bull;</span> Fifteen Million Merits</p>
                        ...
                        <a href="playerBlackMirror.html">
                            <div class="row mb-2 bg-preto">
                                <div class="col-4 p-0"><img class="tamanhoImagem" src="imagens/categorias/series/blackmirror/preview.jpg"></div>
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 3 <span class="text-dourado">&bull;</span> The Entire History of you</p>
                    ...
                    <div class="tab-pane pt-0 linksCategorias" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <a href="playerBlackMirror.html">
                            <div class="row mb-2 bg-preto">
                                <div class="col-4 p-0"><img class="tamanhoImagem" src="imagens/categorias/series/blackmirror/preview.jpg"></div>
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 1 <span class="text-dourado">&bull;</span> Be Right Back</p>
                        ...
                        <a href="playerBlackMirror.html">
                            <div class="row mt-2 mb-2 bg-preto">
                                ...
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column" style="font-size: 1rem;">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 2 <span class="text-dourado">&bull;</span> White Bear</p>
                        ...
                        <a href="playerBlackMirror.html">
                            <div class="row mt-2 mb-2 bg-preto">
                                <div class="col-4 p-0"><img class="tamanhoImagem" src="imagens/categorias/series/blackmirror/preview.jpg"></div>
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column" style="font-size: 1rem;">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 3 <span class="text-dourado">&bull;</span> The Waldo Moment</p>

                                    <p class="m-0 mobileCategoriasTit"><i class="far fa-star text-dourado"></i> 6.7 </p>
                                </div>
                            </div>
                        </a>
                        <a href="playerBlackMirror.html">
                            <div class="row mt-2 mb-2 bg-preto">
                                <div class="col-4 p-0"><img class="tamanhoImagem" src="imagens/categorias/series/blackmirror/preview.jpg"></div>
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column" style="font-size: 1rem;">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 4 <span class="text-dourado">&bull;</span> White Christmas</p>
                    ...
                    <div class="tab-pane pt-0 linksCategorias" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <a href="playerBlackMirror.html">
                            <div class="row mb-2 bg-preto">
                                <div class="col-4 p-0"><img class="tamanhoImagem" src="imagens/categorias/series/blackmirror/preview.jpg"></div>
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 1 <span class="text-dourado">&bull;</span> Nosedive</p>
                        ...
                        <a href="playerBlackMirror.html">
                            <div class="row mt-2 mb-2 bg-preto">
                                <div class="col-4 p-0"><img class="tamanhoImagem" src="imagens/categorias/series/blackmirror/preview.jpg"></div>
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column" style="font-size: 1rem;">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 2 <span class="text-dourado">&bull;</span> Playtest</p>
                    ...
                    <div class="tab-pane pt-0 linksCategorias" id="setting" role="tabpanel" aria-labelledby="setting-tab">
                        <a href="playerBlackMirror.html">
                            <div class="row mb-2 bg-preto">
                                <div class="col-4 p-0"><img class="tamanhoImagem" src="imagens/categorias/series/blackmirror/preview.jpg"></div>
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 1 <span class="text-dourado">&bull;</span> USS Callister</p>
                        ...
                        <a href="playerBlackMirror.html">
                            <div class="row mt-2 mb-2 bg-preto">
                                <div class="col-4 p-0"><img class="tamanhoImagem" src="imagens/categorias/series/blackmirror/preview.jpg"></div>
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column" style="font-size: 1rem;">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 2 <span class="text-dourado">&bull;</span> Arkangel</p>

                                    <p class="m-0 mobileCategoriasTit"><i class="far fa-star text-dourado"></i> 7.3</p>
                                </div>
                            </div>
                        </a>
                        <a href="playerBlackMirror.html">
                            <div class="row mt-2 mb-2 bg-preto">
                                <div class="col-4 p-0"><img class="tamanhoImagem" src="imagens/categorias/series/blackmirror/preview.jpg"></div>
                                <div class="col-8 d-flex align-items-start justify-content-center flex-column" style="font-size: 1rem;">
                                    <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Episode 3 <span class="text-dourado">&bull;</span> Crocodile</p>
