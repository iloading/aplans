        ...
        <article class="container-fluid p-0 mb-5">
            <div id="back" class="imgCategorias mt-0">
                ...
                <div class="container-fluid alturaCategorias backgroundCategorias">
                    ...
                    <div class="row pb-2">
                        <h3 class="col-12 m-0 text-center font-weight-bold" style="font-size: 3rem">Room</h3>
                    </div>
                    <div class="row pb-2">
                        <p class="col-12 m-0 text-center">2015</p>
                    </div>
                ...
                <div class="col-10 mx-auto">
                    <p>Held captive for years in an enclosed space, a woman (Brie Larson) and her young son (Jacob Tremblay) finally gain their freedom, allowing the boy to experience the outside world for the first time.</p>

                </div>
                <div class="container-fluid mt-5 linksCategorias">
                    <a href="playerDeparted.html">
                    ...
                    <div class="row mt-2 mb-2 bg-preto">
                        ...
                        <div class="col-8 d-flex align-items-start justify-content-center flex-column" style="font-size: 1rem;">
                            <p class="m-0 font-weight-bold mobileCategoriasTit" style="font-size: 2rem">Pulp Fiction  <span class="text-dourado">&bull;</span>  1994</p>
                            <p class="m-0 mobileCategorias"><span class="font-weight-bold text-dourado">Director</span> : Quentin Tarantino</p>
                            <p class="m-0 mobileCategorias"><span class="font-weight-bold text-dourado">Cast</span> : Quentin Tarantino, Uma Thurman, John Travolta, etc...</p>
                            <p class="m-0 mobileCategoriasTit"><i class="far fa-star text-dourado"></i> 8.9</p>
                        </div>
                    </div>
                    </a>
                    <a href="playerWhiplash.html">
                    <div class="row mt-2 mb-2 bg-preto">
